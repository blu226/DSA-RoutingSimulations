...
if p_id == 1:
    ...
    plt.legend(routing_name_list, loc="upper left", fontsize=12, ncol = 1, frameon=False)
elif p_id ==3:
...
# if p_id == 1:
#     plt.legend(["Geo-opt(5)", "Geo-pes(5)", "Geo-wei(5)", "SER-opt", "SER-pes", "SER-wei", "TV", "LTE", "CBRS", "ISM"], loc="lower left", fontsize=10, ncol = 4, frameon=False)
#
# elif p_id == 2:
#     plt.legend(["Geo-opt(5)", "Geo-pes(5)", "Geo-wei(5)", "SER-opt", "SER-pes", "SER-wei",  "TV", "LTE", "CBRS", "ISM"], loc="upper left", fontsize=10, ncol = 4, frameon=False)
# elif p_id ==3:
#     plt.legend(["Geo-opt(5)", "Geo-pes(5)", "Geo-wei(5)", "SER-opt", "SER-pes", "SER-wei",  "TV", "LTE", "CBRS", "ISM"], loc="upper right", fontsize=10, ncol = 4, frameon=False)
# elif p_id ==4:
#     plt.legend(["Geo-opt(5)", "Geo-pes(5)", "Geo-wei(5)", "SER-opt", "SER-pes", "SER-wei", "TV", "LTE", "CBRS", "ISM"], loc="upper left", fontsize=10, ncol = 4, frameon=False)
