...
if p_id == 1:
    ...
    fig_name = "Plots/pdr_ttl_SER.png"

if p_id == 2:
    plt.ylabel('Network delay (min)', fontsize=25)
    fig_name = "Plots/latency_ttl_SER.png"

if p_id == 3:
    plt.ylabel('Energy per packet (J)', fontsize=25)
    fig_name = "Plots/energy_ttl_SER.png"

if p_id == 4:
    plt.ylabel('Message overhead', fontsize=25)
    fig_name = "Plots/overhead_ttl_SER.png"
...
if p_id == 1:
    ...
    plt.legend(["Geo-opt", "Geo-pes", "Geo-wei", "SER-opt", "SER-pes", "SER_wei", "TV", "LTE", "CBRS", "ISM"], loc="upper left", fontsize=10, ncol = 1, frameon=False)
elif p_id ==3:
    plt.legend(["Geo-opt", "Geo-pes", "Geo-wei", "SER-opt", "SER-pes", "SER_wei", "TV", "LTE", "CBRS", "ISM"], loc="upper left", fontsize=10, ncol = 4, frameon=False)
elif p_id ==4:
    plt.legend(["Geo-opt", "Geo-pes", "Geo-wei", "SER-opt", "SER-pes", "SER_wei", "TV", "LTE", "CBRS", "ISM"], loc="upper right", fontsize=10, ncol = 1, frameon=False)
